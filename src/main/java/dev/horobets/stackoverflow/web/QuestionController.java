...
public class QuestionController {
    ...
    public QuestionController(QuestionService questionService, ConversionService conversionService) {
    ...
    public ResponseEntity<Page<QuestionResponse>> list(Pageable pageable) {
        ...
        Page<QuestionResponse> mapped = page.map(q -> conversionService.convert(q, QuestionResponse.class));
    ...
    public ResponseEntity<QuestionResponse> get(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(conversionService.convert(q, QuestionResponse.class));
    }
    ...
    public ResponseEntity<QuestionResponse> create(@RequestBody @Valid QuestionRequest request,
        ...
        QuestionResponse body = conversionService.convert(q, QuestionResponse.class);
